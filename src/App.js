  ...
  return (
    <div className="App">
      <header className="App-header">
        <nav className="navbar">
          ...
          <div className="nav-comp">
            <p onMouseOut={handleHome} onMouseEnter={handleHome} >Home</p>
            <p onMouseOut={handleAbout} onMouseEnter={handleAbout} >About</p>
            <p onMouseOut={handleSupport} onMouseEnter={handleSupport} >Support</p>
          </div>
      ...
      <main className="content-wrap">
        ...
        <div >
          {hm ? <div className="home-curse" >This is a static website.Here the page present a menu card and at the below, word to get images be there.It was designed mainly target to fun and educate your kid. </div> : hm}
          {am ? <div className="about-curse" > <p>This Website is developed by Akash S, India.</p>  It is developed using ReactJS.</div> : am}
          {sm ? <div className="support-curse" >For contact :
          <ul>
